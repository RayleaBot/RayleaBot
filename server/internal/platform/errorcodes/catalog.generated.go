...
var catalog = map[string]Definition{
	...
	PlatformResourceMissing:                   {Code: PlatformResourceMissing, HTTPStatus: 503, MessageKey: PlatformResourceMissingMessageKey, Message: "缺少必要资源", Retryable: false, Surfaces: "http,websocket,readiness,plugin_protocol"},
