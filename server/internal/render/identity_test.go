...
func TestRenderIdentityKeepsProtocolIdentityAndPermissionsSeparate(t *testing.T) {
	...
	onebot := RenderIdentityData([]string{"10001"}, event)
	...
	official := RenderIdentityData([]string{"10001"}, event)
	...
	if identity := RenderIdentityData(nil, event); identity.Group != nil {
