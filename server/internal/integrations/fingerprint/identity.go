...
func (p *IdentityProvider) ApplyHeaders(req *http.Request, referer, origin string) {
...
func (p *IdentityProvider) ApplyPostHeaders(req *http.Request, referer, origin string) {
	p.ApplyHeaders(req, referer, origin)
