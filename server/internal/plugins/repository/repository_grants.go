...
func (r *SQLiteRepository) LoadGrants(ctx context.Context, pluginID string) ([]plugins.PluginGrant, error) {
	...
	now := time.Now().UTC()
	var grants []plugins.PluginGrant
	for _, row := range rows {
		g := plugins.PluginGrant{
...
func (r *SQLiteRepository) SaveGrant(ctx context.Context, grant plugins.PluginGrant) error {
