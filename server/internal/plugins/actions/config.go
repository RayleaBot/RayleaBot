...
func (s *Service) executeConfigRead(ctx context.Context, pluginID string, action runtimeaction.Action) (map[string]any, error) {
...
func (s *Service) executeConfigWrite(ctx context.Context, pluginID string, action runtimeaction.Action) (map[string]any, error) {
...
func (s *Service) executeLoggerWrite(ctx context.Context, pluginID, requestID string, action runtimeaction.Action) (map[string]any, error) {
