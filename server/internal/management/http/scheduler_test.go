...
func (s schedulerTestSystem) ValidateRecoveryConfirmRequest([]string, string) *SystemHTTPError {
	return nil
}

func (s schedulerTestSystem) SubmitRecoveryRecheckTask() (string, *SystemHTTPError) {
	return "", nil
}

func (s schedulerTestSystem) SubmitRecoveryConfirmTask([]string, string, string) (string, *SystemHTTPError) {
	return "", nil
}
...
func (s schedulerTestSystem) SchedulerPluginName(pluginID string) string {
	if name := s.pluginNames[pluginID]; name != "" {
		return name
	}
	return pluginID
}
