...
func (h *TaskHandlers) HandleTaskList() http.HandlerFunc {
...
func (h *TaskHandlers) HandleTaskDetail() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func (h *TaskHandlers) HandleTaskCancel() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		taskID := chi.URLParam(r, "task_id")
		snapshot, ok := h.tasks.Get(taskID)
		if !ok {
