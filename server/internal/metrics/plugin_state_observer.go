...
func RefreshPluginStateGauge(registry *Registry, catalog *plugincatalog.Catalog) {
...
func StartPluginStateGaugeRefresh(registry *Registry, catalog *plugincatalog.Catalog) (stop func()) {
