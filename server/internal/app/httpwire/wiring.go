...
func Build(deps BuildDeps) State {
	...
	thirdPartyHandler := thirdpartyapi.NewThirdPartyHandlers(services.ThirdParty, deps.BilibiliAccountClient, services.ThirdPartyQRLogin, services.BilibiliSource, deps.BilibiliHTTPTransport, thirdpartyapi.WithDouyinUserResolver(services.DouyinBrowser))
