...
func registerAppProtectedRoutes(router chi.Router, deps httpServerDeps) {
	...
	router.Get("/api/system/render/templates/{template_id}/source", deps.renderHandler.handleSystemRenderTemplateSource())
	router.Put("/api/system/render/templates/{template_id}/source", deps.renderHandler.handleSystemRenderTemplateSourcePut())
	router.Post("/api/system/render/templates/{template_id}/validate", deps.renderHandler.handleSystemRenderTemplateValidate())
	router.Get("/api/system/render/templates/{template_id}/versions", deps.renderHandler.handleSystemRenderTemplateVersions())
	router.Post("/api/system/render/templates/{template_id}/rollback", deps.renderHandler.handleSystemRenderTemplateRollback())
