// Package reconnect holds the shared reconnect pacing used by chat adapters.
// It is protocol-neutral: an adapter supplies its configured bounds and asks
// for the delay before its next attempt.
package reconnect
