...
func TestAuthShellDoesNotAddPublicRoutes(t *testing.T) {
	...
	cases := []struct {
		...
		{method: http.MethodDelete, path: "/api/governance/blacklist/entries/user/10001", want: http.StatusUnauthorized},
		...
		{method: http.MethodDelete, path: "/api/governance/whitelist/entries/user/10001", want: http.StatusUnauthorized},
