...
func TestAuthShellDoesNotAddPublicRoutes(t *testing.T) {
	...
	cases := []struct {
		...
		{method: http.MethodPost, path: "/api/governance/blacklist/entries", want: http.StatusUnauthorized},
		{method: http.MethodDelete, path: "/api/governance/blacklist/entries/user/10001?kind=global&source_protocol=onebot11", want: http.StatusUnauthorized},
		{method: http.MethodGet, path: "/api/governance/whitelist", want: http.StatusUnauthorized},
		{method: http.MethodPut, path: "/api/governance/whitelist/state", want: http.StatusUnauthorized},
		{method: http.MethodPost, path: "/api/governance/whitelist/entries", want: http.StatusUnauthorized},
		{method: http.MethodDelete, path: "/api/governance/whitelist/entries/user/10001?kind=global&source_protocol=onebot11", want: http.StatusUnauthorized},
