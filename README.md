...
- **三方平台与 Bilibili 深度集成** — 内置 Bilibili、微博、抖音、网易云音乐账号管理，Bilibili 直播/动态实时监控，自研反风控体系（设备指纹、代理池、WBI 签名、验证码自动过检、brotli 直播流）
...
| 能力 | 说明 |
|------|------|
| 三方账号 | Bilibili、微博、抖音、网易云音乐 Cookie 管理；Bilibili 支持 CK 扫码登录、多账号轮转和凭据状态诊断 |
| 订阅中心 | Bilibili、微博、抖音、网易云音乐订阅配置和聊天链接解析 |
