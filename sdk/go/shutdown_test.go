...
func TestShutdownCancellationIsNotLoggedAsHandlerFailure(t *testing.T) {
	...
	writeFrame(t, encoder, protocolFrame{Bots: &[]Bot{}, ProtocolVersion: ProtocolVersion, Type: "init", Timezone: "Asia/Shanghai", PluginID: "fixture", RequestID: "init", Concurrency: 1})
