...
v0.2 已提供完整的管理面、插件生命周期、治理读取面、日志与诊断入口、模板预览工作区、发布 smoke、恢复 drill、Launcher 版本检查和 release metadata 基线。v0.3 以这些能力为前提，重点补齐仍未闭环的正式能力。
...
| 任务项 | 状态 | 说明 |
| --- | --- | --- |
| v0.2 完成态承接 | ☑️ | `docs/CHANGELOGS/v0.2.md` 作为已完成基线，v0.2 已交付能力不进入 v0.3 待办 |
...
| 管理面可见性 | 🟡 | 插件列表、插件详情、安装对话框和任务日志共享同一份可信摘要 |
