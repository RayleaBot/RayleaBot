...
| Web UI | Vue 3.5.30, Vite 8.0.0, Ant Design Vue 4.2.6, Vue Vben Admin 5.7.0 对齐方案, Pinia 3.0.4, Vue Router 5.0.4, vue-i18n 11.x, lucide-vue-next, Vben request 风格封装, 原生 WebSocket 受控连接封装, Tailwind CSS 4.x, Vitest 3.2.4, Playwright 1.59.1 |
...
**问题**：当前 `web/` 仍以 Element Plus 为组件与样式基线，页面壳、消息提示、表单、表格和布局规则都围绕旧选型组织。正式工程基线已经冻结为 `Ant Design Vue + Vue Vben Admin` 对齐方案，需要把管理面骨架、请求层和样式系统收口到同一条主线。
