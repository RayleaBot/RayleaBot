...
| --- | --- | --- | --- | --- | --- | --- |
| [ ] | P01 | P0/S | CI 输入分类与基线 | — | 进行中 | 分类、门禁与结构规则正反例 |
| [ ] | P02 | P0/M | 监督器与资源关闭 | P01 | 未开始 | — |
| [ ] | P03 | P0/M | 多实例路由与事件补全 | P01 | 未开始 | — |
| [ ] | P04 | P0/M | 安装失败传播与 HTTP 输入边界 | P01 | 未开始 | — |
...
本轮没有运行全量 Server/SDK/Web/Launcher 测试、race、真实外部协议连接、浏览器 E2E、原生桌面、发布打包或签名安装。原评审的规模/重复字符串/零引用数量未全量重算，不作为本计划的当前性能或质量基线。
...
| 2026-09-10 | v2 核实与编制 | 完成 | 待提交 | 采用尚未分发或全新分发前提；统一方案、台账与验收 | 见 §6.1 | 所有整改工作包未开始 |
