...
- Python SDK 当前提供 `send_message`、`send_reply`，并补充 `logger_write`、`storage_get`、`storage_set`、`storage_delete`、`storage_list`、`storage_file_read`、`storage_file_write`、`storage_file_delete`、`storage_file_list`、`http_request`、`config_read`、`config_write`、`scheduler_create`、`event_expose_webhook`、`render_image`。
- Node.js SDK 当前提供 `sendMessage`、`sendReply`，并补充 `loggerWrite`、`storageGet`、`storageSet`、`storageDelete`、`storageList`、`storageFileRead`、`storageFileWrite`、`storageFileDelete`、`storageFileList`、`httpRequest`、`configRead`、`configWrite`、`schedulerCreate`、`eventExposeWebhook`、`renderImage`。
