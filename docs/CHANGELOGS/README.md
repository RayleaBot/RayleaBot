...
[0.5.0 全新分发候选说明](../release/notes/v0.5.0.md) 记录本轮变化、首次安装、插件接入、本版备份恢复和验证限制；验证证据见[候选验收记录](../release/validation-v0.5.0.md)。该候选尚未公开发布，其代码范围已按 v0.4 归档之后的全部提交归纳为下表的 v0.5，不改写既有历史记录。
