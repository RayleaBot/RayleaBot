...
export class LauncherReleaseFeedClient {
  ...
  private async loadSnapshot() {
    ...
    try {
      ...
      const latestReleaseResponse = await fetch(repositoryUrl.replace("https://github.com/", "https://api.github.com/repos/") + "/releases/latest", {
      ...
      let releasePageUrl = String(latestPayload.html_url ?? releaseNotesRef);
