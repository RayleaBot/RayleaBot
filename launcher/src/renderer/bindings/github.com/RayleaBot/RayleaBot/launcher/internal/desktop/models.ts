...
export enum EnvironmentCheckScope {
    /**
     * The Go zero value for the underlying type of the enum.
     */
    $zero = "",
...
export enum LauncherCloseAction {
    /**
     * The Go zero value for the underlying type of the enum.
     */
    $zero = "",
...
export enum LauncherCloseBehavior {
    /**
     * The Go zero value for the underlying type of the enum.
     */
    $zero = "",

    CloseAskEveryTime = "ask_every_time",
    CloseHideToTray = "hide_to_tray",
    CloseExitApplication = "exit_application",
};

export interface LauncherCloseConfirmResponse {
    "action": LauncherCloseAction;
...
export enum LauncherProcessOwnership {
    /**
     * The Go zero value for the underlying type of the enum.
     */
    $zero = "",
    ...
    OwnershipNone = "none",
    OwnershipLauncher = "launcher_managed",
...
export enum RuntimePrepareStatus {
    /**
     * The Go zero value for the underlying type of the enum.
     */
    $zero = "",
