...
const api: LauncherDesktopApi = {
  ...
  checkForUpdates: () => ipcRenderer.invoke(launcherInvokeChannels.checkForUpdates),
  downloadUpdate: () => ipcRenderer.invoke(launcherInvokeChannels.downloadUpdate),
  installDownloadedUpdate: () => ipcRenderer.invoke(launcherInvokeChannels.installDownloadedUpdate),
  ...
  openRepositoryPage: () => ipcRenderer.invoke(launcherInvokeChannels.openRepositoryPage),
