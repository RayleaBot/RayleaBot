...
<template>
  <AppPopover :label="label">
    <button type="button" class="app-help" :aria-label="label"><InfoIcon :size="14" aria-hidden="true" /></button>
    <template #content><p class="app-help__description">{{ description }}</p></template>
  </AppPopover>
</template>
