...
export type ThirdPartyQRCodeLoginPollResponse = components['schemas']['ThirdPartyQRCodeLoginPollResponse']
export type ThirdPartyQRCodeLoginState = components['schemas']['ThirdPartyQRCodeLoginState']
...
export type BilibiliSourceDiagnosis = components['schemas']['BilibiliSourceDiagnosis']
