export const plugins = {
  store: {
    title: '插件商店',
    description: '从签名目录中发现、安装和更新独立发布的插件。',
    ...
    confirm: {
      title: '确认安装插件',
      warning: '插件是本机可信代码',
      description: '安装 {name} 后，其 Go 后端会以当前 RayleaBot 进程所属用户的权限运行。请确认发布者和源码仓库可信。',
      action: '确认并安装',
    },
    feedback: {
    ...
    empty: {
      title: '没有匹配的插件',
      description: '调整搜索条件，或刷新已签名的插件目录。',
    },
  },
  title: '插件列表',
  install: '安装插件',
