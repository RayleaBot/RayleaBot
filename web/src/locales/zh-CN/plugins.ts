export const plugins = {
  ...
  inspection: {
    trustTitle: '第三方插件是完全可信的本地代码',
    trustDescription: '原生插件进程使用当前用户权限运行。仅安装来源、平台、摘要和权限均符合预期的代码。',
    pluginValue: '{name}（{id}）',
    license: '许可证',
    packageDigest: '包摘要',
    targetPlatform: '目标平台',
    backend: '后端',
    managementPage: '管理页面',
    managementPageValue: '{entry}（{count} 个文件）',
    none: '无',
    artifact: 'Artifact 校验',
    artifactValue: 'v{version} · {count} 个文件',
    artifactInvalid: '未通过',
    expiresAt: '有效期',
    permissions: '声明权限',
    confirmTrust: '我已核对来源、目标平台、artifact 摘要和权限，并信任此代码使用本机当前用户权限运行。',
    inspect: '检查插件包',
  },
} as const
